...
csk_label = f"countersunk Ø{CSNK_DIAMETER} mm × {CSNK_DEPTH} mm deep" if COUNTERSINK else "plain through-hole"
...
def _make_solid_cutter(name, hx, hy, r_bottom, r_top, height, centre_z):
    ...
    ret  = bmesh.ops.create_cone(
        bm, cap_ends=True, cap_tris=False, segments=HOLE_SEGMENTS,
